...
/***************************定时器相关方法******************************/ //每隔一段时间开启一个定时器
-(void)startTimer{
    self.timer = [NSTimer scheduledTimerWithTimeInterval:2.0 target:self selector:@selector(nextPage:) userInfo:nil repeats:YES];             //userINgo  :传递一个参数
